...
ggplot(summerTeams1, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals First 60")
ggplot(summerTeams2, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Second 60")
ggplot(summerTeams3, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Third 60")
ggplot(summerTeams4, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Fourth 60")
ggplot(summerTeams5, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Fifth 60")
ggplot(summerTeams6, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Sixth 60")
ggplot(summerTeams7, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Seventh 60")
ggplot(summerTeams8, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Summer Countries Totals Last 60")
ggplot(winterTeams1, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Winter Countries Totals First 60")
ggplot(winterTeams2, aes(x=Team,y=Total)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle=90)) + ggtitle("Winter Countries Totals Last 60")
summerTotals <- summerTeams %>% rename('Summer Total'=Total)
winterTotals <- winterTeams %>% rename('Winter Total'=Total)
Totals <- full_join(summerTotals,winterTotals)
Totals1<-Totals[1:60,]
